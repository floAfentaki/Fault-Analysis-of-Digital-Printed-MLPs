...
module top ( inp, out );
  ...
  INVX1 U69 ( .A(n59), .Y(n34) );
  AND2X1 U70 ( .A1(n46), .A2(n45), .Y(n48) );
  ...
  NAND2X1 U76 ( .A1(inp[9]), .A2(inp[13]), .Y(n38) );
  AND2X1 U77 ( .A1(inp[11]), .A2(n29), .Y(out[1]) );
  NAND2X1 U78 ( .A1(n26), .A2(inp[9]), .Y(n46) );
  ...
  NAND2X1 U90 ( .A1(n27), .A2(n34), .Y(out[0]) );
endmodule
