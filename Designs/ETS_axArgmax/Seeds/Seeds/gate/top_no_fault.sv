...
module top ( inp, out );
  ...
  AND2X1 U40 ( .A1(n33), .A2(n46), .Y(n52) );
  INVX1 U41 ( .A(n52), .Y(n39) );
  AND2X1 U42 ( .A1(n44), .A2(n45), .Y(n59) );
  INVX1 U43 ( .A(n59), .Y(n40) );
  AND2X1 U44 ( .A1(n47), .A2(n33), .Y(n55) );
  INVX1 U45 ( .A(n55), .Y(n41) );
  NOR2X1 U46 ( .A1(inp[11]), .A2(inp[2]), .Y(n42) );
  NOR2X1 U47 ( .A1(n42), .A2(inp[27]), .Y(n45) );
  NAND2X1 U48 ( .A1(inp[11]), .A2(inp[2]), .Y(n43) );
  NAND2X1 U49 ( .A1(n43), .A2(inp[23]), .Y(n44) );
  OR2X1 U50 ( .A1(inp[3]), .A2(inp[19]), .Y(n46) );
  ...
  NAND2X1 U56 ( .A1(n55), .A2(n36), .Y(n57) );
